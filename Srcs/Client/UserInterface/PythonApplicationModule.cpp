...
#ifdef ENABLE_ATLAS_MARK_ON_WARP_SCROLLS
	PyModule_AddIntConstant(poModule, "ENABLE_ATLAS_MARK_ON_WARP_SCROLLS", 1);
#else
	PyModule_AddIntConstant(poModule, "ENABLE_ATLAS_MARK_ON_WARP_SCROLLS", 0);
#endif
}
